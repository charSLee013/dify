...
import { Custom, CustomText } from '@/app/components/base/icons/src/public/llm'
...
const config: ProviderConfig = {
  selector: {
    ...
    icon: <Custom className='w-full h-full' />,
  },
  item: {
    key: ProviderEnum.custom,
    titleIcon: {
      'en': <CustomText className='h-6' />,
      'zh-Hans': <CustomText className='h-6' />,
    },
    disable: {
      tip: {
  ...
  modal: {
    ...
    icon: <Custom className='h-6' />,
    link: {
      href: 'https://github.com/ggerganov/llama.cpp/discussions/795',
      label: {
        'en': 'How to deploy OpenAI compatible web server',
        'zh-Hans': '如何部署 openai兼容服务器',
      },
    },
    defaultValue: {
